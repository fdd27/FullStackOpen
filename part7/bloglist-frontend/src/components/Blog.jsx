  ...
  return (
    <div>
      ...
      >
        ...
        <button id="btnView" onClick={toggleView}>
          view
        </button>
      </div>
      <div
      ...
      >
        ...
        <button id="btnHide" onClick={toggleView}>
          hide
        </button>
        <br />
        ...
        <button id={`btnLike_${blog.title}`} onClick={addLike}>
          like
        </button>
        <br />
        ...
        {blog.user.username === user.username && (
          <button id="btnDelete" onClick={deleteBlog}>
            delete
          </button>
        )}
      </div>
